...
package no.difi.idporten.oidc.proxy.openid.cmdline;
...
public class DailyMotionSample {
  ...
  static final JsonFactory JSON_FACTORY = new MockJsonFactory();

  private static final String TOKEN_SERVER_URL = "https://api.dailymotion.com/oauth/token";
  private static final String AUTHORIZATION_SERVER_URL =
      "https://eid-exttest.difi.no/opensso/oauth2/authorize";
  ...
  private static void run(HttpRequestFactory requestFactory) throws IOException {
    DailyMotionUrl url = new DailyMotionUrl("https://eid-exttest.difi.no/opensso/oauth2/authorize");
